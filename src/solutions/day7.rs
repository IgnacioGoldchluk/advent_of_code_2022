// Not mine, copied from https://github.com/Nauss/AdventOfCode/blob/main/2022/day_7/src/main.rs
// because recursiveness in Rust is horrible.
...
pub fn solution() {
    ...
    fs::read_to_string("inputs/day7_input")
        .unwrap()
        .lines()
        .for_each(|line| {
